...
const Cart = () => {
  ...
  const { products, router, navigateWithLoading, cartItems, addToCart, updateCartQuantity, getCartCount, currency } = useAppContext();
    ...
    <>
      ...
      <div className="flex flex-col md:flex-row gap-10 px-6 md:px-16 lg:px-32 pt-6 mb-20 max-w-[1280px] mx-auto">
        <div className="flex-1">
          ...
          <button onClick={()=> navigateWithLoading('/all-products')} className="group flex items-center mt-6 gap-2 text-orange-600">
            <Image
