...
const Footer = () => {
  return (
    <footer>
      <div className="flex flex-col md:flex-row items-start justify-between px-6 md:px-16 lg:px-32 gap-8 md:gap-10 py-10 md:py-14 border-b border-gray-500/30 text-gray-500">
